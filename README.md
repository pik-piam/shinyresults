...
R package **shinyresults**, version **0.34.0**
...
Dietrich J, Humpenoeder F, Sauer P (2025). "shinyresults: A collection of shiny apps and modules to visualize/handle model results." doi:10.5281/zenodo.1478922 <https://doi.org/10.5281/zenodo.1478922>, Version: 0.34.0, <https://github.com/pik-piam/shinyresults>.
